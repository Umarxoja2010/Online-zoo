...
import rasm7 from "../images/garillas1.jpg"
import rasm8 from "../images/garillas2.jpg"
import rasm9 from "../images/garillas3.jpg"
...
<h6>Main cameras</h6>
<iframe className='pandas_video'   src="https://www.youtube.com/embed/h3qJe-bf93w?si=Rrtjcbyl-m_N7PoD" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
<h6>Side cameras</h6>
<div className="pandas_img_collecsiya">
    <img src={rasm7} alt="" />
    <img className='pandas_img_collecsiya_del1' src={rasm8} alt="" />
    <img className='pandas_img_collecsiya_del' src={rasm9} alt="" />
</div>
<div className="pandas_information">
    <div className="pandas_information_left">
        <h2>Information</h2>
        <span>Zoo</span>
        <a href="https://gracegorillas.org/">GRACE gorillas</a>
        <span>Type of aviary</span>
        <p>Imitation of the natural environment</p>
        <span>Habitat</span>
        <a href="https://gorillas.org/about-gorillas/gorilla-facts/">Eastern Democratic Republic of the Congo, southwestern Uganda and Rwanda</a>
        <span>Type of food</span>
        <p>Bamboo shoots and fruits, termites and ants.</p>
