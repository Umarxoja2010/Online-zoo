...
import rasm7 from "../images/pandas.jpg"
import rasm8 from "../images/pandas2.jpg"
import rasm9 from "../images/pandas3.jpg"
...
<h6>Main cameras</h6>
<iframe className='pandas_video'  src="https://www.youtube.com/embed/GPY1T7XGEvY?si=AvC93PpCM_7Ch9e2" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
<h6>Side cameras</h6>
...
<div className="pandas_information">
    <div className="pandas_information_left">
        <h2>Information</h2>
        <span>Zoo</span>
        <a href="https://www.chinadiscovery.com/sichuan-tours/wolong-panda-reserve.html">Shenshuping Gengda Panda Center</a>
        <span>Type of aviary</span>
        <p>Imitation of the natural environment</p>
        <span>Habitat</span>
        <a href="https://en.wikipedia.org/wiki/Mountains_of_Southwest_China">Mountains of southwest China</a>
